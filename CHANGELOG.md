...
* feat(deps): update crossplane-contrib/function-auto-ready docker tag to v0.6.4 (#21) (by @renovate[bot])

  Co-authored-by: renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>


See full diff: [v0.10.0...v0.11.0](https://github.com/hops-ops/aws-auto-eks-cluster/compare/v0.10.0...v0.11.0)
